...
class Ui_Frame_1(object):
    def setupUi(self, Frame_1):
        if not Frame_1.objectName():
            Frame_1.setObjectName(u"Frame_1")
    ...
    def retranslateUi(self, Frame_1):
        Frame_1.setWindowTitle(QCoreApplication.translate("Frame_1", u"Frame", None))
        self.header.setText(QCoreApplication.translate("Frame_1", u"Search Playlist", None))
        self.back_btn.setText("")
        self.forword_btn.setText("")
        self.search_btn.setText(QCoreApplication.translate("Frame_1", u"search", None))
        self.create_btn.setText(QCoreApplication.translate("Frame_1", u"Create", None))
        self.update_btn.setText(QCoreApplication.translate("Frame_1", u"Update", None))
    # retranslateUi
