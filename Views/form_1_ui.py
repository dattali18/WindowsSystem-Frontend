...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.search_field.setStyleSheet("padding: 2 10;")
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(
            QCoreApplication.translate("MainWindow", "Media View", None)
        )
        self.search_field.setText("")
        self.search_field.setPlaceholderText(
            QCoreApplication.translate("MainWindow", "Seach For Movies/Tv Series", None)
        )
        self.combo_box.setItemText(
            0, QCoreApplication.translate("MainWindow", "Movies", None)
        )
        self.combo_box.setItemText(
            1, QCoreApplication.translate("MainWindow", "Tv Series", None)
        )
