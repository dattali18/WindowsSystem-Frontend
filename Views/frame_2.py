...
class Ui_Frame_2(object):
    def setupUi(self, Frame_2):
        ...
        self.seach_field.setObjectName("seach_field")
        ...
        self.click_lbl.setObjectName("click_lbl")
    ...
    def retranslateUi(self, Frame_2):
        Frame_2.setWindowTitle(QCoreApplication.translate("Frame_2", "Frame", None))
        self.header_2.setText(
            QCoreApplication.translate("Frame_2", "Create Playlist", None)
        )
        self.back_btn.setText("")
        self.forword_btn.setText("")
        self.search_btn.setText(QCoreApplication.translate("Frame_2", "search", None))
        self.edit_lbl.setText(
            QCoreApplication.translate("Frame_2", "name your playlist", None)
        )
        self.click_lbl.setText(
            QCoreApplication.translate(
                "Frame_2", "click on the button to create playlist", None
            )
        )
        self.create_btn.setText(QCoreApplication.translate("Frame_2", "Create", None))
